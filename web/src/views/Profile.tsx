          ...
          <div id="bottom-div" className="w-100 mt-5">
            <div id="left-div" className="p-3">
              <ul className="p-0 m-0">
                <li>
                  <i className="fas fa-briefcase" />Cardiologist at London
                  Hospital
                </li>
                <li>
                  <i className="fas fa-graduation-cap" />Studies Neurobiology at
                  FMUP
                </li>
                <li>
                  <i className="fas fa-graduation-cap" />Studied Cardiology at
                  FMUP
                </li>
                <li>
                  <i className="fas fa-home" />Lives in London, England
                </li>
                <li>
                  <i className="fas fa-home" />From Liverpool, England
                </li>
                <li>
                  <i className="fas fa-envelope" />johndoe@mail.com
                </li>
                <li>
                  <i className="far fa-window-maximize" />www.johndoe.com
                </li>
              </ul>
            </div>
            <div id="right-div">
