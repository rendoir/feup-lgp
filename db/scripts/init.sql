...
CREATE TABLE product_exchanges (
    ...
    product BIGINT REFERENCES users ON DELETE CASCADE
);
...
RETURNS TABLE(buyer_id BIGINT, buyer_first_name TEXT, buyer_last_name TEXT,
                product_id BIGINT, product_name TEXT) AS $$
	SELECT product_exchanges.buyer, users.first_name, users.last_name,
